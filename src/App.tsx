  ...
  return (
    <>
      <div className="mx-auto w-full max-w-281.5">
        {/* ===== 1. Header ===== */}
        <header className="flex items-center justify-between px-5 md:px-8 lg:px-12 h-15 md:h-18 lg:h-20 bg-white/95 border-b border-line sticky top-0 z-50 backdrop-blur-sm">
        ...
        <section className="flex flex-col gap-6 lg:flex-row lg:items-center lg:gap-12 xl:gap-20 px-6 md:px-8 lg:px-12 pt-20 md:pt-28 lg:pt-32 pb-14 md:pb-20 lg:pb-24">
          <div className="flex flex-col gap-6 lg:flex-1">
            ...
            <p className="font-body text-base md:text-lg text-muted leading-relaxed lg:max-w-9/10">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 lg:gap-6">
            {[
              ...
              <div
                key={num}
                className="flex flex-col gap-5 bg-white border border-line rounded-md p-5.5 md:p-6"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center justify-center w-11 h-11 bg-[#fff7d6] rounded-sm">
                    <Icon className="w-5.5 h-5.5 text-text" />
                  </div>
          ...
          <div className="flex flex-col md:flex-row md:gap-5 gap-4">
            {[
              ...
              >
                ...
                <p className="font-body text-[15px] md:text-base text-text leading-normal">
                  {quote}
                </p>
